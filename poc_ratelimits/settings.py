"""
Django settings for poc_ratelimits project.
...
SECRET_KEY = 'django-insecure-az0mtt&0w=)awat(ja8#ha9mkuxu$!l7%ey45yediw#cas9$*s'
...
WSGI_APPLICATION = 'poc_ratelimits.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'timeout': 20,  # Incrementa el timeout a 20 segundos
        },
    }
}
